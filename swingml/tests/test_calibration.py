...
def test_a_table_survives_the_round_trip_through_disk(tmp_path) -> None:  # type: ignore[no-untyped-def]
    confidence, error = synthetic(400, seed=7)
    calibration = build_calibration(
        confidence, error, measured_on=MEASURED_ON, n_clips=400, n_bins=3
    )
